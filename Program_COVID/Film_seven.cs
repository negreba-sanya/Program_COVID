...
{
    public partial class Film_seven : Form
    {
        public Film_seven()
        {
            InitializeComponent();
        ...
        private void Film_seven_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Film_seven_KeyDown(object sender, KeyEventArgs e)
        {
