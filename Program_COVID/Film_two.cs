...
{
    public partial class Film_two : Form
    {
        public Film_two()
        {
            InitializeComponent();
        ...
        private void Film_two_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Film_two_KeyDown(object sender, KeyEventArgs e)
        {
